...
{
// stop current movement if it exists
  if (isThereMovementToSpecAngle[1] == true)
    isThereMovementToSpecAngle[1] = false;
// sleep 100ms
  usleep(100000);
  auto moveToSpecificAngle2 = [angleToReach]()
  {
    moveAxisToSpecificAngle2(angleToReach);
  };
  std::thread threadMoveToSpecificAngle2(moveToSpecificAngle2);
  threadMoveToSpecificAngle2.detach();
}
int main()
{
...
// 2 347ccw;77;167//30
    ...
    {
      moveAxisToSomeAngle2(60);
      usleep(2000000);
      moveAxisToSomeAngle2(140);
    };
